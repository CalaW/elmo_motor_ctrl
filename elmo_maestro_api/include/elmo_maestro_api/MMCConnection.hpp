...
public:
    ...
    void GetVersion_Ex()  ;
    void GetLibVersion();
    void GetVersionEx(std::string& strVersion) ;
    void GetVersion(ELMO_INT32& iVer) ;
    ...
    */
    void SetGlobalBoolParameter(ELMO_LINT32 lValue, MMC_PARAMETER_LIST_ENUM eNumber, ELMO_INT32 iIndex) ;
    void SetGlobalParameter(ELMO_DOUBLE dbValue, MMC_PARAMETER_LIST_ENUM eNumber, ELMO_INT32 iIndex) ;
    ELMO_LINT32 GetGlobalBoolParameter(MMC_PARAMETER_LIST_ENUM eNumber, ELMO_INT32 iIndex) ;
    ELMO_DOUBLE GetGlobalParameter(MMC_PARAMETER_LIST_ENUM eNumber, ELMO_INT32 iIndex) ;
    //
    void SaveParameters() ;
    void LoadParameters() ;
    void SetDefaultManufacturerParameters() ;
    void SetIsToLoadGlobalParams(ELMO_UINT8 ucVal) ;
    void SetHeartBeatConsumer(ELMO_UINT32 uiHeartbeatTimeFactor) ;
	...
	void GetMaestroTime(ELMO_UINT16 &year, ELMO_UINT16 &month, ELMO_UINT16 &day, ELMO_UINT16 &hour,
			ELMO_UINT16 &minute, ELMO_UINT16 &second, ELMO_UINT16 &milliSecond) ;
    ...
    void SetEventsMask(ELMO_UINT32 uiEventMask) ;
    void ClearEventsMask(ELMO_UINT32 uiEventMask) ;
    ELMO_UINT32 GetEventsMask() ;
